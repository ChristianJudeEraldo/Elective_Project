...
namespace LESSON1
{
    ...
    public partial class Project : Form
    {
        ...
        private void Activity2_Load(object sender, EventArgs e)
        {
            ...
            string variable = "C:\\Users\\Jude\\OneDrive\\POS_images\\"; //change this to your own path
        ...
        {
            cd_itemname.Text = "Breakfast Meal A";
            cd_price.Text = "75.00";
            cd_quant.Enabled = true;
            cd_quant.Focus();
        ...
        {
            cd_itemname.Text = "Special Burger";
        ...
        private void CalculateBtn_Click(object sender, EventArgs e)
        {
            ...
            p_cashrendered.Text = cash_rendered.ToString("n");
        ...
        {
            cd_itemname.Text = "Steak on the House";
        ...
        {
            cd_itemname.Text = "Shawarma Plate";
